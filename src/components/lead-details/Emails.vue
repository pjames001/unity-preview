...
const filteredEmails = computed(() => {
  ...
  return sortedEmails.value.filter(email =>
    ...
    email.receiver.some(r => r.toLowerCase().includes(query))
  );
});
        ...
        <table class="w-full text-left border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-2">
                {{ email.subject }}
                <v-icon name="hi-phone-incoming" scale=".9" class="dark:text-white text-gray-700"></v-icon>
              </td>
                    ...
                    >
                      ...
                      <div class="text-sm space-y-4 text-gray-800 dark:text-gray-200">
                        ...
                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                          ...
                          <ul v-if="email.attachments.length" class="list-disc ml-5">
                            <li
                          ...
                          <p v-else class="italic text-gray-400 dark:text-gray-500">No attachments</p>
                        </div>
                      </div>
                    </div>
                  </div>
